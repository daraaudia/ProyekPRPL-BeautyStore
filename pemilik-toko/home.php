...
<body class="bg-warning">
                    ...
                    <div class="collapse navbar-collapse font-weight-semi-bold justify-content-end" id="navbarNavDropdownMenu">
                        <ul class="navbar-nav">
                            <li class="nav-item p-2">
                                <a class="nav-link btn btn-primary" href="home.php"><i class="fa fa-home"></i> Home</a>
                            </li>
                            <li class="nav-item p-2">
    ...
    <div class="container my-4 text-center">
        <div class="jumbotron bg-primary">
            ...
            <p class="lead">
                <a class="btn btn-lg btn-warning" href="rekap-data-penjualan.php" role="button"><i class="fa fa-files-o" aria-hidden="true"></i> Lihat Rekap Data Penjualan</a>
            </p>
        </div>
    </div>
