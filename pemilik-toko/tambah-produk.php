                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse font-weight-semi-bold justify-content-end" id="navbarNavDropdownMenu">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item p-2">
                                <a class="nav-link btn btn-primary" href="tambah-produk.php"><i class="fa fa-plus-square" aria-hidden="true"></i> Tambah Produk</a>
                            </li>
                            <li class="nav-item p-2">
    ...
    <div class="container my-4 text-center">
        <div class="row justify-content-center">
            <div class="col-8 bg-warning py-4 shadow">
                <h3 class="text-warning border bg-primary py-4">FORM TAMBAH PRODUK</h3>
                <hr />
